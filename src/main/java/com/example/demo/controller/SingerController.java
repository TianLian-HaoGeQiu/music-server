...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            //E:\0_teach\UI\shixun\music-website-master\music-server\img\singerPic\singerPic
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:E:\\0_teach\\UI\\shixun\\music-website-master\\music-server\\img\\singerPic\\");
        }
    }
...
//    添加歌手
    ...
    public Object addSinger(HttpServletRequest req){
        ...
        if (res){
            ...
            return jsonObject;//将json类型的数据返回前端
        }else {
